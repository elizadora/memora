...
export default function FeaturesSection (){
    return (
        <section className="bg-white-smoke w-full flex justify-center flex-col items-center gap-12 py-44">
            <h3 className="font-roboto-slab md:text-4xl text-3xl  text-rich-black font-medium ">Funcionalidades</h3>
            <div className="flex justify-evenly xl:justify-evenly  md:flex-row flex-col gap-10 md:gap-0">
