...
export default function Navbar() {
  ...
  return (
    <header className="flex justify-between items-center bg-oxford-blue text-platium drop-shadow-md py-6 px-8 md:px-10 font-roboto-slab">
      <h1 className="font-bold text-[28px]">MEMORA</h1>
      <div className="hidden lg:flex items-center gap-7">
        <button className="w-40 rounded-xl text-base border-2 border-orange px-8 py-2 cursor-pointer hover:bg-orange hover:text-oxford-blue transition ease-in duration-300">Entrar</button>
        <button className="w-40 rounded-xl text-base bg-orange px-8 py-2 cursor-pointer hover:opacity-95 text-oxford-blue transition ease-in duration-300">Criar Conta</button>
      </div>
