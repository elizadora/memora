...
export default function HeroSection() {
    ...
    return (
        <section className="flex mt-28 lg:justify-between xl:justify-around xl:px-0 lg:px-10 lg:flex-row flex-col items-center lg:items-start gap-10 mb-10 px-2">
            ...
            <img src={heroImage} alt="Hero Image" className="lg:w-1/2 w-7/10 max-w-[526px]" />
        </section>
    )
}