...
export default function BenefitsSection() {
    return (
        <section className="flex mt-28 lg:justify-around xl:px-0 px-8 lg:flex-row flex-col items-center lg:items-start gap-10 mb-10">
            ...
            <img src={benefitsImage} alt="Hero Image" className="lg:w-1/3 w-7/10 max-w-[526px]" />
        </section>
    );
}